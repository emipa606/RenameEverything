...
namespace RenameEverything
{
    public class RenameEverythingSettings : ModSettings
    {
        ...
        public void DoWindowContents(Rect wrect)
        {
            ...
            options.Gap();
            options.CheckboxLabeled("RenameEverything.ShowNameOnGround".Translate(), ref showNameOnGround,
                "RenameEverything.ShowNameOnGround_Tooltip".Translate());

            // Append original label to an object's name
            options.Gap();
            options.CheckboxLabeled("RenameEverything.AppendCachedLabel".Translate(), ref appendCachedLabel,
            ...
            options.Gap();
            options.CheckboxLabeled("RenameEverything.AppendCachedLabelInThingHolder".Translate(),
            ...
            options.Gap();
            options.CheckboxLabeled("RenameEverything.ShowRenameGizmosOnPawns".Translate(), ref pawnWeaponRenameGizmos,
                "RenameEverything.ShowRenameGizmosOnPawns_Tooltip".Translate());
            ...
            else
            {
                ...
                options.Gap();
                options.CheckboxLabeled("RenameEverything.ShowBothWeaponNamesDualWield".Translate(),
